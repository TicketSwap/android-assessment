...
object Reactive {
    ...
    val rxKotlin2   = "io.reactivex.rxjava2:rxkotlin:2.3.0"
...
//    val runner = "com.android.support.test:runner:1.1.0"
    ...
    val mockk = "io.mockk:mockk:1.8.12"
...
object ArchComponents {
    ...
    val lifecycle           = "android.arch.lifecycle:extensions:${Version.lifecycleVersion}"
}